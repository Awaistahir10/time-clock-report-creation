...
const PDFForSingleUser = ({ dynamicData, downloadPdf, viewPdf, userId }) => {
  ...
  const generatePDF = () => {
    // Filter dynamicData to get data for the specified userId
...
export default PDFForSingleUser;
